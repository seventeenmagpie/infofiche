...
BLOG_AUTHOR = "Seventeen Magpie"  # (translatable)
BLOG_TITLE = "Infofiche"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://infofiche.uk/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://infofiche.uk/"
BLOG_EMAIL = "seventeenmagpie@infofiche.uk"
BLOG_DESCRIPTION = "SFF, linguistics and related and unrelated"  # (translatable)
...
<div class="sidebar-module sidebar-module-inset">
  <h4>About</h4>
  <p>Infofiche is a blog about science fiction, fantasy and linguistics. Made by Seventeen Magpie and sparked by Arkady Martine's <em>A Memory Called Empire</em>. I post seasonally.</p>
</div>
<div class="sidebar-module">
  <h4>Links</h4>
  <ol class="list-unstyled">
    <li><a href="https://discord.gg/eyYKSsPBR2">Discord server.</a></li>
    <li><a href="https://app.thestorygraph.com/profile/seventeenmagpie">Storygraph</a></li>
    <li><a href="https://infofiche.uk/pages/has-reads/">Has reads</a></li>
    <li><a rel="me" href="https://hachyderm.io/@yarrharr">Mastodon</a></li>
  </ol>
</div>
"""}
